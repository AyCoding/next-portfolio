        ...
        <div className="container max-w-[1200px] mx-auto pb-[40px] px-5 md:px-2 sm:flex sm:flex-col sm:justify-center sm:h-screen">
            ...
            <section className="w-full h-52 py-5 md:rounded-3xl">
                <p className="text-xl text-gray-700">
                    Bonjour, je suis Aymeric DE LANGE, développeur front-end passionné par la programmation web depuis 2018. Au
                    fil des années, j&apos;ai acquis une solide expérience en développement web front-end, ce qui m&apos;a permis
                    de créer divers projets intéressants. Je vous invite à découvrir mes projets. N&apos;hésitez
