            ...
            <div className="flex flex-col gap-10 container mx-auto pb-[50px] px-5 md:px-2">
                ...
                <div className="flex flex-col gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <p>ScoreResto est une application permettant l&apos;apprentissage l&apos;architecture Modèle-Vue-Contrôleur en PHP.</p>
                    </div>
                    <div>
                        <h1 className="text-2xl font-medium mb-2 w-full">
                    ...
                    <div>
                        ...
                        <h2 className="text-xl text-slate-400 pb-4">PHP MVC MySQL / Svelte</h2>
                        <p>
